...
\todo[inline]{Add the following columns: Temporal Context Window Size; Per class Accuracy; After adding these two columns, we'll need to make the table double column.}
